...
public class AmbilWarnaDialog {
    ...
    public AmbilWarnaDialog(final Context context, int color, boolean supportsAlpha, OnAmbilWarnaListener listener) {
        ...
        dialog = new AlertDialog.Builder(context, R.style.AlertDialogCustomStyle)
        ...
        dialog.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialogInterface) {
                ...
                if (positiveButton != null) {
                    positiveButton.setTextColor(context.getResources().getColor(android.R.color.holo_green_dark));
                }

                if (negativeButton != null) {
                    negativeButton.setTextColor(context.getResources().getColor(android.R.color.holo_green_dark));
                }
            }
        });
    ...
    public static void setGradient(){
     /*  TextPaint paint = tv.getPaint();
        float width = paint.measureText("Edge Lighting");

        Shader textShader = new LinearGradient(0, 0, width, tv.getTextSize(),
                new int[]{
                        Color.parseColor("#F9F018"),
        ...
        tv.setTextColor(Color.parseColor("#F9F018"));*/
    }
}
