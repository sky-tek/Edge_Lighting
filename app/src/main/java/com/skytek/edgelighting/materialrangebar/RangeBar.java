...
import com.skytek.edgelighting.materialrangebar.Bar;
import com.skytek.edgelighting.materialrangebar.ConnectingLine;
import com.skytek.edgelighting.materialrangebar.PinView;
import com.skytek.edgelighting.materialrangebar.IRangeBarFormatter;
...
public class RangeBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIsRangeBar) {
            ...
            mConnectingLine.drawright(canvas,mRightThumb,getBarLength());
            mConnectingLine.drawleft(canvas,mLeftThumb,getBarLength());
            if (drawTicks) {
