...
import com.skytek.edgelighting.receiver.AdminReceiver
import com.skytek.edgelighting.utils.Global
import com.skytek.edgelighting.utils.Root
    ...
    protected open fun finishAndOff() {
        if (PreferenceManager.getDefaultSharedPreferences(this).getBoolean("root_mode", false)) {
            ...
            if (policyManager.isAdminActive(ComponentName(this, AdminReceiver::class.java))) {
                ...
                Toast.makeText(this, "Activate this device admin for normal mode\\nPlease note that you have to deactivate the app\\'s device admin privileges before uninstalling it!", Toast.LENGTH_SHORT).show()
            }
        }
        finish()
    }
